...
def load_data_and_vectorize():
    # Load dari Data Train (Case Base kita sekarang adalah data train)
...
def predict_outcome(query: str, vectorizer, tfidf_matrix, df, case_solutions) -> tuple:
    ...
    return predicted_pasal, predicted_solution, top_5_ids
...
def main():
    ...
    for q in queries:
        ...
        predicted_pasal, predicted_solution, top_5_ids = predict_outcome(
